...
class TestFrenchToEnglish(unittest.TestCase): 
    def test1(self): 
        self.assertNotEqual(french_to_english(None), '') # test when Null is entered, Should return None.
        self.assertEqual(french_to_english("Bonjour"), "Hello")  # test when "Bonjour" is entered should return "Hello"
        
class TestEnglishToFrench(unittest.TestCase): 
    def test1(self): 
        self.assertNotEqual(english_to_french(None), '') # test when Null is entered, Should None.
